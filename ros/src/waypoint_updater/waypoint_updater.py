...
class WaypointUpdater(object):
    ...
    def generate_lane(self):
        ...
        cur_waypoints = self.base_waypoints.waypoints[closest_idx:farthest_idx]
        if self.stopline_wp_idx == -1 or (self.stopline_wp_idx >= farthest_idx):
            lane.waypoints = cur_waypoints
        else:
            lane.waypoints = self.decelerate_waypoints(cur_waypoints, closest_idx)
        return lane
